    ...
    public static void addDebugMenu(final CRDMainActivity activity) {
        ...
        builder.addFunction(new DebugFunction("Time travel") {
            ...
            public String call() throws Exception {
                ...
                return "Today is now the next tuesday (or 08:09:45 if today is Tuesday anyway), "
                    + CRDUtils.epochToHumanReadableDate(CRDTimeManager.getNowTimeMilli());
            }
            ...
            public String call() throws Exception {
                ...
                return "Today is now the next wednesday, "
                    + CRDUtils.epochToHumanReadableDate(CRDTimeManager.getNowTimeMilli());
            }
            ...
            public String call() throws Exception {
                ...
                return "Leaped forward in time of 24 hours. Today is " + CRDUtils.epochToHumanReadableDate(
                    CRDTimeManager.getNowTimeMilli());
            }
            ...
            public String call() throws Exception {
                ...
                return "Leaped forward in time of 7 days. Today is "
                    + CRDUtils.epochToHumanReadableDate(CRDTimeManager.getNowTimeMilli());
            }
            ...
            public String call() throws Exception {
                ...
                return
                    "Application time changed to what time it is now actually. No more time traveling for you ! Today"
                        + " is "
                        + CRDUtils.epochToHumanReadableDate(CRDTimeManager.getNowTimeMilli());
            }
